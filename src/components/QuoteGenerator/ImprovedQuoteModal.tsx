...
// import { subEventsData } from '../../data/subEventsData'; // Not used in this component
                                                ...
                                                >
                                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                                        {formData.subEvents.map(subEventId => {
                                                            const eventServices = eventSpecificServices.find((es: any) => es.eventId === subEventId);
                                                            return eventServices?.availableServices.map((service: any) => (
                                                                <label
                                                                    key={service.id}
