...
const SelectorChips: React.FC<SelectorChipsProps> = ({ 
  ...
  return (
    <div className="flex flex-wrap gap-2 max-w-full w-full bg-background border border-brand-primary/10 p-4 rounded-3xl shadow-lg/10">
      {options.map((option) => {
        ...
        return (
          <motion.button
            ...
            initial={false}
            animate={{
              backgroundColor: isSelected ? "#008B8B" : "#fff", // brand-primary teal
              borderColor: isSelected ? "#006666" : "#d1d5db",
